...
export const initialTestRecords: CrudRecord[] = [
  {
    id: 'TKT-101',
    ...
    urgency: 'High',
    status: 'Pending',
    description: 'Overflowing communal garbage bin near the intersection requiring immediate pickup.',
  ...
  },
  {
    ...
    urgency: 'Low',
    status: 'Resolved',
    description: 'Litter scattered near park benches, cleared by assigned response team.',
  ...
  },
  {
    ...
    urgency: 'Critical',
    status: 'In Progress',
    description: 'Illegal dumping site blocking pedestrian sidewalk access on main avenue.',
  ...
  },
  {
    ...
    urgency: 'Medium',
    status: 'Pending',
    description: 'Uncollected storm debris and green waste accumulating along curb.',
