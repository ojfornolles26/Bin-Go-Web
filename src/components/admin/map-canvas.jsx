...
export default function MapCanvas({ tickets, mapMode = "heatmap" }) {
  ...
  if (!mounted) {
    return (
      <div className="w-full h-full min-h-[400px] relative rounded-xl overflow-hidden border border-slate-200 bg-slate-100 flex items-center justify-center text-slate-400">
        Loading Map...
      </div>
    );
  }

  const getHeatmapColor = (urgency) => {
    switch (urgency) {
      case "Critical":
  ...
  const getHeatmapRadius = (urgency) => {
    switch (urgency) {
      case "Critical":
        return 500;
      case "High":
  ...
  return (
    <div className="w-full h-full min-h-[400px] relative rounded-xl overflow-hidden border border-slate-200 z-0">
      <MapContainer
            ...
            >
              ...
              <Popup>
                <div className="p-1 font-sans flex flex-col gap-1.5 min-w-[165px]">
                  <h3 className="font-bold text-slate-900 text-sm m-0 pb-1 border-b border-slate-100">
                    {ticket.id}
                  </h3>
                  <p className="text-xs font-semibold text-slate-700 m-0 leading-tight">
