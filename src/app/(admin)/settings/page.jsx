        ...
        <form onSubmit={handleProfileSave} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                <option value="Brgy. Guadalupe (Metro Cebu)">
                  Brgy. Guadalupe (Metro Cebu)
                </option>
                <option value="Brgy. Lahug (Metro Cebu)">
                  Brgy. Lahug (Metro Cebu)
                </option>
                <option value="Brgy. Mabolo (Metro Cebu)">
                  Brgy. Mabolo (Metro Cebu)
                </option>
                <option value="Brgy. Kasambagan (Metro Cebu)">
                  Brgy. Kasambagan (Metro Cebu)
                </option>
                <option value="Brgy. Tisa (Metro Cebu)">
                  Brgy. Tisa (Metro Cebu)
                </option>
                <option value="Brgy. Labangon (Metro Cebu)">
                  Brgy. Labangon (Metro Cebu)
                </option>
                <option value="Brgy. Talamban (Metro Cebu)">
                  Brgy. Talamban (Metro Cebu)
                </option>
              </select>
            </div>
          ...
          <div className="pt-2 flex justify-end">
            <Button
              ...
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-2.5 rounded-xl text-xs transition-all cursor-pointer inline-flex items-center gap-1.5 shadow-xs active:scale-[0.98]"
            >
              {savingProfile && (
      ...
      <section className="bg-white border border-slate-200 rounded-xl p-6 shadow-xs">
        <div className="divide-y divide-slate-100">
          ...
          <div className="flex items-center justify-between py-3.5 first:pt-0 last:pb-0">
            <div>
              <h3 className="text-sm font-semibold text-slate-900">
                Critical Dumping Alerts
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">
                Immediate dispatch notification for high & critical priority
                dumping reports.
              </p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between py-3.5 first:pt-0 last:pb-0">
            <div>
              <h3 className="text-sm font-semibold text-slate-900">
                Truck GPS Signal & Idle Warnings
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">
                Notify when garbage trucks lose GPS connection or idle over 15
                minutes.
              </p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between py-3.5 first:pt-0 last:pb-0">
            <div>
              <h3 className="text-sm font-semibold text-slate-900">
                Audio Chime on Emergency Reports
              </h3>
              <p className="text-xs text-slate-500 mt-0.5">
                Play audible alert sound in command center tab for emergency
                reports.
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3.5 py-2 text-sm bg-white border border-slate-200 rounded-lg focus:outline-none focus:border-emerald-600 font-medium text-slate-900 cursor-pointer"
              >
                <option value="auto-nearest">
                  Auto-Assign Nearest Available Truck
                </option>
                <option value="manual">Manual Command Center Dispatch</option>
                <option value="barangay-supervisor">
                  Barangay Supervisor Approval Required
                </option>
              </select>
            </div>
          </div>
