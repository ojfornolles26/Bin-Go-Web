  ...
  return (
    <div className="flex flex-col gap-4 pb-6">
      ...
      <div className="flex flex-col gap-3">
        {/* Accumulation Density Bar positioned above the map */}
          <div className="self-start max-w-full flex-wrap sm:flex-nowrap bg-white px-4 py-2.5 rounded-xl border border-slate-200 shadow-xs flex items-center gap-3 text-xs font-bold text-slate-700 transition-all">
            <span className="text-slate-500 font-semibold text-xs whitespace-nowrap w-[135px] transition-all">
              {mapMode === "heatmap" ? "Accumulation Density:" : "Urgency Level:"}
            </span>
        ...
        <div className="w-full min-h-[500px] h-[calc(100vh-240px)] relative rounded-xl overflow-hidden border border-slate-200 shadow-sm">
